  ...
  return (
    <>
      <form
        ...
        className="w-full h-[46%] justify-center xl:gap-5 gap-0 py-3 grid grid-rows-2 xl:grid-rows-2 xl:grid-cols-4 grid-cols-3 xl:px-9 px-3 items-center justify-items-center"
      >
        {data.map((item, i) => {
          if (i === 0) {
            return (
